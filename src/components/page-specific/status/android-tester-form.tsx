...
export function AndroidTesterForm() {
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg">
      <CardHeader>
        <CardTitle className="font-headline text-center">Become an Android Tester</CardTitle>
        <CardDescription className="text-center">
          Get early access to our Android app and help us shape its future. Sign up below!
        </CardDescription>
      </CardHeader>
      <CardContent>
        <EmailCaptureForm
